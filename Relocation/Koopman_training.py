        ...
        if koopmanoption == "Drafted":
            ...
            if not Unseen_test:
                ...
                if not controller or error_type == 'demo':
                    ...
                    if False:
                        koopman_policy_visualization_unseenTest(env_name, Koopman, cont_koopman_operator, Training_data, Velocity, num_hand, num_obj, koopmanoption)
                    obj_ori_error_simu, obj_ori_error_simu_koopman, computed_joints_unseen, success_rate = koopman_policy_control_unseenTest(env_name, Controller, Koopman, cont_koopman_operator, Training_data, Velocity, num_hand, num_obj, koopmanoption, Visualize)      
